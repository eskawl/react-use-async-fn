...
export interface useAsyncArgs<F extends BasicAsyncFn> {
    fn: F;
    onDone?: (result: Awaited<ReturnType<F>>, ctx: {
        args: Parameters<F>;
    }) => void;
...
export type AsyncTrigger<F extends BasicAsyncFn> = (...args: Parameters<F>) => Promise<Awaited<ReturnType<F>>>;
export interface AbortableLifecycle {
    abortSignal: AbortSignal;
}
export type BasicAbortableAsyncFn = (...args: [...any[], AbortableLifecycle]) => Promise<any>;
...
export type AbortableAsyncTrigger<F extends BasicAbortableAsyncFn> = (...args: TupleExceptLast<Parameters<F>>) => Promise<ReturnType<F>>;
